...
cat(paste0(
  ##{%s} causes jekyll Liquid syntax error (line 136): Tag '{%' was not properly terminated with regexp: /\%\}/ in _pages/publications.Rmd
  "I have several scientific contributions \\citep{",
  paste(refs.wide[order(year), ref], collapse=","),
  "}."),
  file="../assets/citep.tex")
system(paste("cd ../assets && rm -f TDH-refs.pdf TDH-refs.aux TDH-refs.bbl && pdflatex TDH-refs && bibtex TDH-refs && pdflatex TDH-refs && pdflatex TDH-refs && evince TDH-refs.pdf &"))
```
