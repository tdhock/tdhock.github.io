...
- Please download my [TDH-refs.bib](/assets/TDH-refs.bib) BibTeX
  ...
  list of publications below and in [this PDF](/assets/TDH-refs.pdf).
...
refs.fields <- refs.dt[, nc::capture_all_str(
  ...
  by=.(type, ref)]
suppressWarnings(suppressPackageStartupMessages(library(data.table)))#for dcast
refs.wide <- dcast(
...
cat(paste0(
  ...
  "Toby Dylan Hocking has ",
  nrow(refs.wide),
  " scientific contributions on his publications page \\citep{",
