...
- Teaching any of the above subjects. Example tutorials about [[https://github.com/tdhock/regex-tutorial][named
  capture regular expressions]], [[https://github.com/tdhock/when-c][interfacing C/C++ code with R/Python]],
  [[https://github.com/tdhock/graphics-tutorial][graphics for publication]], [[https://github.com/tdhock/datatable-foverlaps][computing overlapping genomic regions]], and
  [[https://github.com/tdhock/animint-tutorial][animated, interactive data visualization]].
...
Je suis disponible pour travailler en :
- Programmation des paquets R ou modules Python, y compris C/C++. Par
  ...
  plotly dans R]].
- Visualisation interactive et animée de données. Prototypage rapide
...
- Développement de modèles très efficaces pour la prédiction, en
...
- Enseignement dans les sujets ci-dessus. Par exemple des tutoriels en
  anglais sur [[https://github.com/tdhock/regex-tutorial][la capture nommée dans les expressions rationnelles]],
  [[https://github.com/tdhock/when-c][l'utilisation de C/C++ avec R/Python]], [[https://github.com/tdhock/graphics-tutorial][graphiques pour publication]],
  [[https://github.com/tdhock/datatable-foverlaps][computation de chevauchement]], et [[https://github.com/tdhock/animint-tutorial][la visualisation intéractive et
  animée]].
...
R/Python/C/C++/JavaScript, [[https://github.com/tdhock?tab%3Drepositories][disponible sur GitHub]]. Plus d'infos en anglais
