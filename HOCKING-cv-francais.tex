...
\begin{tabular*}{6.1in} {@{\extracolsep{\fill}}ll}
 Courrier : & Citoyenneté : Américaine \\            
...
\vspace*{-.1in}
\begin{list2}
\item[] Research Assistant en statistique et biochimie avec Jeff Miller.
...
En plus de publier dans les journaux, je publie fréquemment dans les
actes de conférences d'apprentissage automatique très sélectives
telles que ICML et NIPS,
qui ont des comités de lecture doublement aveugle. 
...
\section{\sc Projets en cours (pas soumis)}

%Venuto D,
{\bf Hocking TD}, Spanurattana S, Sugiyama M. Support vector
...
{\bf Autres compétences logicielles} : C, C++, JavaScript, SQL.
