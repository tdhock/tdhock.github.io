...
```
## INFO  [07:47:25.119] [bbotk] Starting to optimize 0 parameter(s) with '<TunerBatchInternal>' and '<TerminatorEvals> [n_evals=1, k=0]'
## INFO  [07:47:25.120] [bbotk] Evaluating 1 configuration(s)
## INFO  [07:47:25.125] [mlr3] Running benchmark with 1 resampling iterations
## INFO  [07:47:27.452] [mlr3] Applying learner 'classif.mlp' on task 'MNIST_FashionMNIST' (iter 1/1)
## INFO  [07:48:52.986] [mlr3] Finished benchmark
## INFO  [07:48:53.043] [bbotk] Result of batch 1:
## INFO  [07:48:53.045] [bbotk]  internal_valid_score warnings errors runtime_learners internal_tuned_values                                uhash
## INFO  [07:48:53.045] [bbotk]             0.7957105        0      0           84.396             <list[1]> 1f93fff0-148c-4851-b3f1-c863ae3ebd6b
## INFO  [07:48:53.066] [bbotk] Finished optimizing after 1 evaluation(s)
## INFO  [07:48:53.067] [bbotk] Result:
## INFO  [07:48:53.068] [bbotk]  internal_tuned_values learner_param_vals  x_domain internal_valid_score
## INFO  [07:48:53.068] [bbotk]                 <list>             <list>    <list>                <num>
## INFO  [07:48:53.068] [bbotk]              <list[1]>         <list[19]> <list[0]>            0.7957105
```
...
##       <num>     <fctr>     <fctr>     <num>
##    1:     1   subtrain    logloss 2.1909526
##    2:     2   subtrain    logloss 1.9003253
##    3:     3   subtrain    logloss 1.7046954
##    4:     4   subtrain    logloss 1.5593798
##    5:     5   subtrain    logloss 1.4425272
##   ---                                      
## 3996:   996 validation error_prop 0.2017982
## 3997:   997 validation error_prop 0.2027972
## 3998:   998 validation error_prop 0.2027972
## 3999:   999 validation error_prop 0.2027972
## 4000:  1000 validation error_prop 0.2007992
```
...
##   torch_model_classif.patience=1000, torch_model_classif.min_delta=0, torch_model_classif.batch_size=200,
...
```
## INFO  [07:49:09.055] [bbotk] Starting to optimize 0 parameter(s) with '<TunerBatchInternal>' and '<TerminatorEvals> [n_evals=1, k=0]'
## INFO  [07:49:09.056] [bbotk] Evaluating 1 configuration(s)
## INFO  [07:49:09.060] [mlr3] Running benchmark with 1 resampling iterations
## INFO  [07:49:09.304] [mlr3] Applying learner 'select.torch_ingress_num.nn_head.torch_loss.torch_optimizer.torch_callbacks.torch_model_classif' on task 'MNIST_FashionMNIST' (iter 1/1)
## INFO  [07:52:31.977] [mlr3] Finished benchmark
```

```
## Error in self$assert(xs, sanitize = TRUE): Assertion on 'xs' failed: Parameter 'torch_model_classif.opt.lr' not available..
```
...
```
## Error: tentative d'appliquer un objet qui n'est pas une fonction
```
...
## Caused by error:
## ! objet 'torch_model_classif.epochs' introuvable
```
...
## [1] future_1.34.0             mlr3resampling_2024.10.28 mlr3torch_0.2.1           torch_0.14.2             
## [5] mlr3pipelines_0.7.2       mlr3_0.23.0               ggplot2_3.5.1             data.table_1.17.99       
## 
## loaded via a namespace (and not attached):
##  [1] shape_1.4.6.1        lattice_0.22-6       listenv_0.9.1        digest_0.6.37        magrittr_2.0.3      
##  [6] evaluate_1.0.3       grid_4.4.3           iterators_1.0.14     jsonlite_1.9.1       foreach_1.5.2       
## [11] glmnet_4.1-8         Matrix_1.7-3         processx_3.8.6       safetensors_0.1.2    backports_1.5.0     
## [16] mlr3learners_0.10.0  survival_3.8-3       ps_1.9.0             scales_1.3.0         coro_1.1.0          
## [21] mlr3tuning_1.3.0     mlr3measures_1.0.0   codetools_0.2-20     palmerpenguins_0.1.1 cli_3.6.4           
## [26] rlang_1.1.5          crayon_1.5.3         future.apply_1.11.3  parallelly_1.42.0    bit64_4.6.0-1       
## [31] munsell_0.5.1        splines_4.4.3        withr_3.0.2          nc_2025.1.21         tools_4.4.3         
## [36] parallel_4.4.3       uuid_1.2-1           checkmate_2.3.2      colorspace_2.1-1     globals_0.16.3      
## [41] bbotk_1.5.0          vctrs_0.6.5          R6_2.6.1             lifecycle_1.0.4      bit_4.6.0           
## [46] mlr3misc_0.16.0      pkgconfig_2.0.3      callr_3.7.6          pillar_1.10.1        gtable_0.3.6        
## [51] glue_1.8.0           Rcpp_1.0.14          lgr_0.4.4            paradox_1.0.1        xfun_0.51           
## [56] tibble_3.2.1         knitr_1.50           farver_2.1.2         labeling_0.4.3       compiler_4.4.3
```
