...
plot(pred.write.chr.cols)+scale_x_log10("N = number of columns")
```
...
```
## Warning in scale_x_log10("N = number of columns"): log-10 transformation introduced infinite values.
```
...
plot(pred.read.chr.cols)+scale_x_log10("N = number of columns")
```
...
plot(pred.write.chr.rows)+scale_x_log10("N = number of rows")
```
...
```
## Warning in scale_x_log10("N = number of rows"): log-10 transformation introduced infinite values.
```
...
plot(pred.write.num.cols)+scale_x_log10("N = number of columns")
```
...
## [11] directlabels_2024.1.21 reticulate_1.34.0.9000 lattice_0.22-6         R6_2.5.1               generics_0.1.3        
## [16] knitr_1.47             tibble_3.2.1           polars_0.19.1          munsell_0.5.0          DBI_1.2.1             
## [21] atime_2024.11.29       pillar_1.9.0           rlang_1.1.3            utf8_1.2.4             xfun_0.45             
## [26] quadprog_1.5-8         cli_3.6.2              withr_3.0.0            magrittr_2.0.3         grid_4.5.0            
## [31] rappdirs_0.3.3         lifecycle_1.0.4        vctrs_0.6.5            bench_1.1.3            evaluate_0.23         
