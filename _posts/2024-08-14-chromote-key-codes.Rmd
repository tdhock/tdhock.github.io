...
for TODO.
The goal of this post is to TODO.
...
The table above could be used to expand the keys supported in
`animint2` tests. To verify that it is compatible with the ones
already used in the tests, we can further subset to get the keys we
use in `animint2` tests:
