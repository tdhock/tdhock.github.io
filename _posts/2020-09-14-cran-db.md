...
> nick.dt[nickname!=""][1:5]
           before nickname after
1:           Jie      Kate    Hu
2:         Yifan     Ethan    Xu
3: Bao Sheng Loe     Aiden      
4:       Zhiyuan     Jason    Xu
5:       Kuan-Yu      Alex  Chen
```
...
```r
> nick.dt[nickname!=""][1:5]
           before nickname after          full
1:           Jie      Kate    Hu        Jie Hu
2:         Yifan     Ethan    Xu      Yifan Xu
3: Bao Sheng Loe     Aiden       Bao Sheng Loe
4:       Zhiyuan     Jason    Xu    Zhiyuan Xu
5:       Kuan-Yu      Alex  Chen  Kuan-Yu Chen
```
...
```r
> nc.maint <- stringi::stri_trans_general(nick.dt[["full"]], "latin-ascii")
> nc.sorted <- data.table(nc.maint)[, .(
+   count=.N
+ ), by=.(orig.maint=nc.maint)][order(-count)]
> nc.top20 <- nc.sorted[1:20]
> identical(nc.top20, orig.top20)
[1] TRUE
```

But what about the other names? There are 58 which are not the same:
