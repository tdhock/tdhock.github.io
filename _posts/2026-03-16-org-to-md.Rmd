...
knitr::opts_chunk$set(
  ...
  fig.height=6)
if(FALSE){
  system("cd ~/R/animint-manual-en && git checkout 1eb3e69e4f1e97e53a8a0153d73677743e802f0b")
  knitr::knit(paste0(post.id, ".Rmd"))
  system("cd ~/R/animint-manual-en && git restore chapters/*/index.qmd chapters/*qmd")
}
```
...
for(row_i in 1:nrow(sub_dt)){
  ...
  subject <- sub_row[, gsub(find, replace, subject)]
}
cat(subject)
```
