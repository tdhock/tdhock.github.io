...
In this section we show how it is possible using [mlr3::ResamplingCustom](https://mlr3.mlr-org.com/reference/mlr_resamplings_custom.html)
...
options(width=100)
(train.test.dt <- data.table::rbindlist(train.test.dt.list))

mlr3.dt <- data.table(features=c("easy","impossible"))[, {
  feature.name.vec <- grep(
