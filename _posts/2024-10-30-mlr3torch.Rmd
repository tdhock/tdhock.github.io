...
* https://mlr-org.github.io/mlr3torch-course/notebooks/6-mlr3torch.html
  which explains how to mlr3torch pipe operations to define a neural network, and
...
glearner_linear_ce$configure(
  validate = 0.5,
  predict_type = "prob",
  ##torch_model_classif.patience=10,
  torch_model_classif.measures_valid = measure_list,
  torch_model_classif.measures_train = measure_list)
```
...
glearner_linear_ce$model$callbacks$history
bl_linear_ce$model$callbacks$history
```
