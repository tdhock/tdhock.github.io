...
PI on NSERC Discovery grant, 210,000\$CAD, 2026--2031. ``Optimization algorithms for complex objective functions in supervised machine learning, with applications to classification and change-point detection.''
...
{\it Statistical Analysis and Data Mining} 19(1), 2026.
...
Gurney KR, Aslam B, Dass P, Gawuc L, {\bf Hocking TD}, Barber JJ, and Kato A. Assessment of the climate trace global powerplant CO2 emissions. {\it Environmental Research Letters}, 19(11):114062, 2024.
...
Oliveira P, Amoakohene D, {\bf Hocking TD}, Gerosa M, Steinmacher I.
Governance Matters: Lessons from Restructuring the data.table OSS Project.
{\it IEEE International Conference on Software Maintenance and Evolution (ICSME)}, 2025.
...
Networks. Chapter 36 (pages 309-317) in textbook {\it Land Carbon Cycle Modeling: Matrix
  Approach, Data Assimilation, and Ecological Forecasting}, edited by
Yiqi Luo and Benjamin Smith, published in 2022 by Taylor and Francis.

{\bf Hocking TD} (2018). Animated interactive data visualization using
animint2 in R. Free online textbook, 20 web pages/chapters with interactive graphics and exercises.

{\bf Hocking TD} (2026). Visualisation interactive de données dans R avec animint2. Université de Sherbrooke, Département d’informatique. fabriqueREL. Licence CC BY-SA. Free online textbook, 20 web pages/chapters with interactive graphics and exercises. DOI:10.71892/11143/1448 
...
Semi-plenary talk at JDS Marseille, Institut Henri Poincaré, round table panelist for Impact IA colloquium at Paris Saclay, AgroParisTech, Centre Borelli group meeting at ENS Paris Saclay, Madrid useR group, Julie Josse lab meeting at INRIA Montpellier, Institut de Maths de Toulouse, Toulouse R User Group, Toulouse Data Viz meetup, INRAE Toulouse, ETH Zurich, LMU Munich, Rencontres R Mons Belgium (2025); ASU Data-oriented Mathematical and Statistical Sciences seminar, Joint
...
Summer 2026, Université de Sherbrooke, ROP543/631, Optimisation non linéaire (nonlinear optimization).

Winter 2026, Université de Sherbrooke, IFT704, Apprentissage automatique à grande échelle (large-scale machine learning).

Fall 2024, Université de Sherbrooke, IFT603/712, Techniques d’apprentissage (machine learning).

Fall 2024, Université de Sherbrooke, IFT187, Éléments de bases de données (databases).

Fall 2023, Northern Arizona University, CS470, Artificial Intelligence.

Fall 2023, Northern Arizona University, CS599, Deep Learning.

Fall 2023, Northern Arizona University, CS599, Unsupervised Learning.
...
{\bf R}: contributions to regular expressions in base R (2011--2023). Co-author since 2024 of data.table package (I wrote governance, measure function for data reshaping, tests for reverse dependencies and performance). Maintainer of numerous R
packages (20 on CRAN as of April 2026) for machine learning
(cross-validation benchmarks, changepoint detection, classification,
...
generation, atime for asymptotic benchmarks.

{\bf Python}: contributions to pandas module for data manipulation
(str.extractall regex functionality). Author of GUI/web server
