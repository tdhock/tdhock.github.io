...
learning models for large datasets based on optimization algorithms
(regression, classification, ranking, clustering, changepoint
detection, survival analysis). Applications to genomics,
neuroscience, audio, internet, sensors, recommendation systems.
