...
PI on travel grant from DATAIA (Artificial Intelligence research agency in
Paris, France), 24,000 euros, July to December 2024. ``Efficient
algorithms and software for change-point detection.''

PI on National Science Foundation grant, \$726,681, July 2023 to June
2025. ``POSE: Phase II: Expanding the data.table ecosystem for
efficient big data manipulation in R.'' 

Co-PI on National Institutes of Health grant, \$455,660, July 2023 to
June 2027. ``Addressing Structural Determinants of Autism Disparities
...
Joint Statistical Meetings Toronto (2023), Institute of Mathematical
Statistics (2022), IEEE conference in Prescott Arizona, University of
Arizona Math/Stats seminar (2022); ASU West ML Day,
