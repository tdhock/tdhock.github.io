...
% Joint statistical meeting (JSM) 2015 session on ``Recent Advances in
% Interactive Graphics for Data Analysis'' (declined; my collaborator
% Susan VanderPlas gave the talk instead).
