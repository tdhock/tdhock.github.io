...
\begin{tabular*}{6.1in} {@{\extracolsep{\fill}}ll}
 NAU Building 90, Office 210 & Citizenship: USA \\            
...
Data visualization techniques and machine learning models for large
datasets based on optimization algorithms (regression,
classification, ranking, clustering, changepoint detection, survival
analysis). 
Applications to genomics, neuroscience,
...
arXiv:1810.00117. Under review at {\it Journal of Statistical
  Software}.
...
peak detection in genomic data. Preprint arXiv:1703.03352. Under
review at {\it Journal of Machine Learning Research}.
...
regular expressions. Under review at {\it R Journal}.
...
Advances in Neural Information Processing Systems (NIPS), Journal of
...
Editor for Journal of Statistical Software.

\section{\sc Software Online (Selected)} 

{\bf R}: clusterpath, \mbox{penaltyLearning}, mmit, fpop, 
WeightedROC, PeakError, PeakSegDP,
PeakSegJoint, PeakSegOptimal, PeakSegDisk, PeakSegPipeline, 
directlabels, 
plotly, inlinedocs, quadmod, 
animint, 
rankSVMcompare, 
\mbox{neuroblastoma}, breakpointError, SegAnnot,
namedCapture, iregnet, re2r, TnT.
